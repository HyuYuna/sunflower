...
(function($){
  ...
  $._timePicker = function(elm, settings) {
    ...
    $(elm).blur(function() {
	  ...
	  var elmsplit = $(elm).val().split(":");
	  if (elmsplit[0]!="__")
	  {
		elmspliH = elmsplit[0]*1;
		elmspliM = elmsplit[1]*1;
		if (elmspliH>23) setTimeVal(elm, "", $tpDiv, settings);
		if (elmspliM>59) setTimeVal(elm, "", $tpDiv, settings);
	  }
    });
