...
<ul class="nav nav-tabs">
	...
	<li role="presentation" class="active"><a href="/bos/singl/siteConectStats/listOs.do?menuNo=${paramVO.menuNo}">운영체제별</a></li>
...
<form name="frm" method="get" action="/bos/singl/siteConectStats/listOs.do" class="sh" >
...
/*var t_url = "/bos/singl/siteConectStats/findAllBySiteOsConectCount.json?searchCnd=${paramVO.searchCnd}&sdate=${paramVO.sdate}&edate=${paramVO.edate}&smonth=${paramVO.smonth}&emonth=${paramVO.emonth}&pSiteId=${paramVO.pSiteId}";
...
<input type="hidden" name="csrfToken" value="${csrfToken}"/>
<input type="hidden" name="excelTp" value="os" />
<input type="hidden" name="menuNo" value="${paramVO.menuNo}" />
<input type="hidden" name="pSiteId" value="${paramVO.pSiteId}" />
