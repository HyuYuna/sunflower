...
<form id="board" name="board" method="post" enctype="multipart/form-data" action="${action}">
	...
	<div class="view">
		<dl>
			<dt scope="row"><label for="nttSj"><span class="req"><span class="sr-only">필수입력</span></span>게시물제목</label></dt>
			<dd><input type="text" name="nttSj" id="nttSj" class="w100p" value="${result.nttSj}" /></dd>
		</dl>
		<dl>
			<dt scope="row"><label for="ntcrNm"><span class="req"><span class="sr-only">필수입력</span></span>작성자</label></dt>
			<dd><input type="text" name="ntcrNm" id="ntcrNm" class="w100p" value="${empty result ? userVO.userNm : result.ntcrNm}" /></dd>
		</dl>
		<dl>
			<dt scope="row" class="con_tit"><span class="req"><span class="sr-only">필수입력</span></span>내용</dt>
