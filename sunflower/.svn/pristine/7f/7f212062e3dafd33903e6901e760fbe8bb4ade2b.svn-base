...
<ul class="nav nav-tabs">
	...
	<li role="presentation" class="active"><a href="/bos/singl/siteConectStats/listBrowser.do?menuNo=${paramVO.menuNo}">브라우저별</a></li>
	<li role="presentation"><a href="/bos/singl/siteConectStats/listPcMobile.do?menuNo=${paramVO.menuNo}">PC/모바일별</a></li>
</ul>

<form name="frm" method="get" action="/bos/singl/siteConectStats/listBrowser.do" class="sh" >
...
/*var t_url = "/bos/singl/siteConectStats/findAllBySiteBrowserConectCount.json?searchCnd=${paramVO.searchCnd}&sdate=${paramVO.sdate}&edate=${paramVO.edate}&smonth=${paramVO.smonth}&emonth=${paramVO.emonth}&pSiteId=${paramVO.pSiteId}";
...
<input type="hidden" name="csrfToken" value="${csrfToken}"/>
<input type="hidden" name="excelTp" value="browser" />
<input type="hidden" name="menuNo" value="${paramVO.menuNo}" />
<input type="hidden" name="pSiteId" value="${paramVO.pSiteId}" />
