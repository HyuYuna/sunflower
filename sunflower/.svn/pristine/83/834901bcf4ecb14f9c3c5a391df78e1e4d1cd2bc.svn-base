...
<h3 class="first">
			...
			<p>이 약관은 (주)유앤피플 주식회사 ("회사" 또는 "(주)유앤피플")가 제공하는 (주)유앤피플 및 (주)유앤피플 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
			<br/><br/><h3>
			...
			<ol>
			<li><span class="first_letter">①</span>"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 (주)유앤피플 및 (주)유앤피플 관련 제반 서비스를 의미합니다.</li>
			...
			<li><span class="first_letter">②</span>"회사"는 "회원"이 안전하게 "서비스"를 이용할 수 있도록 개인정보(신용정보 포함)보호를 위해 보안시스템을 갖추어야 하며 개인정보처리방침을 공시하고 준수합니다. </li>
			...
			<li><span class="first_letter">③</span>"회원"이 카페, 블로그 서비스를 이용하여 통신판매 또는 통신판매중개를 업으로 하는 경우 전자상거래등에서의소비자보호에관한법률에 따른 의무를 준수하여야 하며, 회사는 개별 서비스 이용약관 및 정책에서 관련 내용을 규정할 수 있습니다.</li>
			...
			<li><span class="first_letter">③</span>본 조에 따른 세부절차는 "정보통신망법" 및 "저작권법"이 규정한 범위 내에서 "회사"가 정한 "게시중단요청서비스"에 따릅니다.<br>
				...
				- 게시중단요청서비스 : 
				<a href="http://help.naver.com/claim_main.asp" target="_blank">http://help.naver.com/claim_main.asp</a>
			</li>
			</ol>
			<br/><br/><h3>
			...
			<li><span class="first_letter">②</span>"회원"이 계약을 해지할 경우, 관련법 및 개인정보처리방침에 따라 "회사"가 회원정보를 보유하는 경우를 제외하고는 해지 즉시 "회원"의 모든 데이터는 소멸됩니다. </li>
			...
			<li><span class="first_letter">①</span>이 약관은 2014년 6월 25일부터 적용됩니다. </li>
			<li><span class="first_letter">②</span>2014년 3월 17일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.</li>
			</ol>
			<p class="past">
				<a href="/rules/service_pre_20140317.html" class="arrow" title="2014년 3월 17일 ~ 2014년 6월 24일 이용약관 보기">이전 이용약관 보기</a>
				(2014년 3월 17일 - 2014년 6월 24일 적용)</p>