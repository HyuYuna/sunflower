...
function fncPrhibtInsert() {
    ...
    varFrom.action = "/bos/sys/prhibtWrdDicary/insert.do?menuNo=${param.menuNo}";
...
function fncPrhibtUpdate() {
	var varFrom = document.getElementById("prhibtManage");
	var str = document.getElementById("wrdNm");
	varFrom.action = "/bos/sys/prhibtWrdDicary/update.do?menuNo=${param.menuNo}";
...
function fncPrhibtDelete() {
	var varFrom = document.getElementById("prhibtManage");
	varFrom.action = "/bos/sys/prhibtWrdDicary/delete.do?menuNo=${param.menuNo}";
...
<table>
	...
	<tbody>
		...
		<tr>
			<th scope="row"><span class="req"><span class="sr-only">필수입력</span></span>적용범위</th>
			<td>
				<input type="radio" name="wrdSe" id="wrdSe1" class="input_radio" value="A" <c:if test="${empty result or result.wrdSe == 'A'}"> checked</c:if> /> <label for="wrdSe1">공통</label>
				<input type="radio" name="wrdSe" id="wrdSe2" class="input_radio" value="L" <c:if test="${result.wrdSe == 'L'}"> checked</c:if> /> <label for="wrdSe2">로그인</label>
				<input type="radio" name="wrdSe" id="wrdSe3" class="input_radio" value="P" <c:if test="${result.wrdSe == 'P'}"> checked</c:if> /> <label for="wrdSe3">비밀번호</label>
			</td>
		</tr>
		<tr>
	...
	<div class="btnSet">
      ...
      <c:if test="${registerFlag == 'UPDATE'}">
		...
		<a class="b-cancel" href="/bos/sys/prhibtWrdDicary/list.do?${pageQueryString}"><span>취소</span></a>
	</div>