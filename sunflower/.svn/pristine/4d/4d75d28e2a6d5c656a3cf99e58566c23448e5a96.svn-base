...
<h1 class="tit_line">첨부파일</h1>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table02">
        ...
        <tbody>
            ...
            <c:forEach var="result" items="${resultFile}" varStatus="status">
            <tr>
                <td style="text-align:center;">${status.count}</td>
                <td style="text-align:center;">${result.uflFileNameOriginal}</td>
                <td style="text-align:left;">${result.uflFileSize}KB</td>
                <td style="text-align:center;">${result.uflCuserNm}</td>
                <td style="text-align:center;">${result.uflDate}</td>
            </tr>
            </c:forEach>
        </tbody>
    </table>
