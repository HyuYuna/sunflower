2018-06-01 강태희
기본폰트 '맑은 고딕'추가 
	/smarteditor/css/smart_editor2_in.css //에디터의 기본값으로 선택된 폰트 '맑은 고딕' 변경
별도로 기본폰트 변경시
	//예제 코드
	fOnAppLoad : function(){
		oEditors.getById['nttCn'].setDefaultFont( "바탕체",15);
	}
...
라이센스 : LGPL v2 
홈페이지 : https://github.com/naver/smarteditor2
...
-javaagent:D:\Project\lib\springloaded-1.2.8.RELEASE.jar -noverify
