...
public class AudioCaptCha {
	public void getAudioCaptCha(HttpServletRequest req, HttpServletResponse resp, String answer) throws IOException, Exception
	{
        ...
        AudioInputStream lowResAIS = AudioSystem.getAudioInputStream(outDataFormat, audiocaptcha.getChallenge().getAudioInputStream());
