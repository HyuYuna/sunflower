...
import site.unp.cms.service.pips.LoginHistService;
...
@Service
public class LoginHistServiceImpl extends DefaultCrudServiceImpl implements LoginHistService{

	@CommonServiceLinks({
		@CommonServiceLink(desc="해외 로그인 이력", linkType=LinkType.BOS, paramString="searchFlag=OVSEA"),
		@CommonServiceLink(desc="모바일 로그인 이력", linkType=LinkType.BOS, paramString="searchFlag=MOBILE"),
		@CommonServiceLink(desc="로그인 실패 이력", linkType=LinkType.BOS, paramString="searchFlag=FAIL"),
		@CommonServiceLink(desc="로그인 이력", linkType=LinkType.BOS, paramString="searchFlag=")
	})
