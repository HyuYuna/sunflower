...
import site.unp.cms.service.singl.LoginPolicyService;
...
@Service
public class LoginPolicyServiceImpl extends DefaultCrudServiceImpl implements LoginPolicyService{
	...
	public void list(ParameterContext paramCtx) throws Exception {
		...
		ZValue result = sqlDao.findOne("findAllloginPolicy", param);
	...
	public void update(ParameterContext paramCtx) throws Exception {
    	ZValue param = paramCtx.getParam();
    	ModelMap model = paramCtx.getModel();
		sqlDao.modify("updateLoginPolicy", param);
		
		MVUtils.goUrl("/bos/singl/loginPolicy/list.do", null, model);
