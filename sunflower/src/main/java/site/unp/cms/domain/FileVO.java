...
public class FileVO implements Serializable {
	...
	public void setConvertCnt(int convertCnt) {
	...
	public String[] getAtchFileIdData() {
		return atchFileIdData;
	}

	public void setAtchFileIdData(String[] atchFileIdData) {
		this.atchFileIdData = atchFileIdData;
	}
