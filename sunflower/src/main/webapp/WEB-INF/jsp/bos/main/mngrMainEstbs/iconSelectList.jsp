...
<script src="/static/jslibrary/jquery.hideseek.min.js"></script>
<link rel="stylesheet" href="/static/jslibrary/bootstrap/css/bootstrap.css" />
<link rel="stylesheet" href="/static/bos/css/bossub.css" />
<style>
body{max-width:1200px;padding:15px;margin: 0 auto;font-size:24px;}
</style>
</head>
<body>

<input data-list=".fontawesome-icon-list" id="search-input" class="form-control input-lg" placeholder="Search icons" autocomplete="off" spellcheck="false" autocorrect="off" tabindex="1" >
<script>
...
<script>
$('.fontawesome-icon-list a').each(function(index, el) {
	$(this).on('click',function(event) {
		event.preventDefault();
		var iconClassName = $(this).find('i').attr('class');
		// alert(iconClassName)
		window.opener.document.getElementById(window.name).value = iconClassName;
		$(window.opener.document.getElementById(window.name)).next('span').attr('class',iconClassName+' fa-3x vm');
		window.close();
