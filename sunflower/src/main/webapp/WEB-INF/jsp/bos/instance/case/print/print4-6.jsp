    ...
    <h1 class="tit_line">연락처</h1>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="table02">
            ...
            <tbody>
	            ...
	            <c:forEach var="result" items="${resultContact}" varStatus="status">
                <tr>
                    <td style="text-align:center;">${status.count}</td>
                    <td style="text-align:center;">${result.ccRel}</td>
                    <td style="text-align:center;">${result.ccName}</td>
                    <td style="text-align:center;">${result.ccPhone}</td>
                    <td style="text-align:center;">${result.ccEmail}</td>
                    <td style="text-align:left;">${result.ccMemo}</td>
                </tr>
                </c:forEach>
            </tbody>
        </table>
