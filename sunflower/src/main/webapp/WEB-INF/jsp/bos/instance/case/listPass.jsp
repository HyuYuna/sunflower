...
<script>
    ...
    function fn_search(){
        ...
        document.frm.action = "/bos/instance/case/listPass.do?menuNo=${param.menuNo}";
        document.frm.submit();
    }
...
/*******************************************************/
    ...
    <div style="clear:both; width:100%;">
        ...
        <caption>지원서비스 목록</caption>
            <thead>
                <tr>
                    <th style="width: 8%" scope="col">피해구분</th>
                    <th style="width: 12%" scope="col">피해자</th>
                    <th style="width: 13%" scope="col">지원일자 <button type="button" name="orderPassDateBtn" id="orderPassDateBtn">▼▲</button></th>
                    <th style="width: 13%" scope="col">수정일자 <button type="button" name="orderPassUDateBtn" id="orderPassUDateBtn">▼▲</button></th>
                    <th style="width: 10%" scope="col">내담자이름</th>
                    <th style="width: 7%" scope="col">관계</th>
                    <th style="width: 7%" scope="col">방법</th>
                    <th style="width: 20" scope="col">지원구분</th>
                    <th style="width: 13%" scope="col">지원요약</th>
                    <th style="width: 7%" scope="col">담당자</th>
                </tr>
            </thead>
            <tbody>
                <c:forEach var="result" items="${resultList}" varStatus="status">
                    ...
                    <tr style="cursor: pointer;" id="trCase" ondblclick="fn_DbClick('${result.caseSeq}', '${passSeq}');">
                        <td class="tit">${result.caseTypeNm}</td>
                        <td>${result.victimName}</td>
                        <td>${result.passDate} ${result.passTime}</td>
                        <td><fmt:formatDate value="${result.passUdate }" pattern="yyyy-MM-dd HH:mm"/></td>
