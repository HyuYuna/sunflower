...
<c:set var="action" value="downloadExcel.do?searchWrd=${param.searchWrd}&searchKwd=${param.searchKwd}&sdate=${param.sdate}&edate=${param.edate}&searchCnd=${param.searchCnd}&searchCnd1=${param.searchCnd1}&searchCnd2=${param.searchCnd2}&viewType=CONTBODY" />
