    ...
    <h1 class="tit_line">사례등록지</h1>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table02">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>세부내용</th>
                        <td colspan="3">${resultMemo.jupsooMemo}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table02">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>세부내용</th>
                        <td colspan="3">${resultMemo.victimMemo}
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table02">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>세부내용</th>
                        <td colspan="5">${resultMemo.caseMemo}
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table02">
                ...
                <tbody>
                    <tr>
                        ...
                        <div id="div_result">
	                        <script>
	                            getCmmnCd.checkBox('CDHP', 'div_result', 'result', '${result.dmgState}', '','D');
	                        </script>
	                    </div>
                        </td>
                    </tr>
                    <tr>
                        <th>주호소 및 상담내용</th>
                        <td>${resultMemo.sangdamMemo}
                        </td>
                    </tr>
                    <tr>
                        <th>사례관리자 설정</th>
                        <td>${result.caseManager}
                        </td>
                    </tr>
                </tbody>
            </table>
