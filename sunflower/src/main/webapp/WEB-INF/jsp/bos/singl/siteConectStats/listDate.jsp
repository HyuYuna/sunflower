...
<c:set var="chartXLabel" value="날짜(일)" />
<c:set var="chartType" value="timeseries" />
<c:choose>
	...
	<c:otherwise>
		...
		<c:set var="chartType" value="category" />
		<c:set var="chartXLabel" value="날짜(월)" />
	</c:otherwise>
</c:choose>

<ul class="nav nav-tabs">
	<li role="presentation" class="active"><a href="/bos/singl/siteConectStats/listDate.do?menuNo=${paramVO.menuNo}">사이트 기간별 통계</a></li>
...
<form name="frm" method="get" action="/bos/singl/siteConectStats/listDate.do" class="sh" >
...
/* var t_url = "/bos/singl/siteConectStats/findAllBySiteConectCount.json?searchCnd=${paramVO.searchCnd}&sdate=${paramVO.sdate}&edate=${paramVO.edate}&smonth=${paramVO.smonth}&emonth=${paramVO.emonth}&pSiteId=${paramVO.pSiteId}";
...
<input type="hidden" name="csrfToken" value="${csrfToken}"/>
<input type="hidden" name="excelTp" value="date" />
<input type="hidden" name="menuNo" value="${paramVO.menuNo}" />
<input type="hidden" name="pSiteId" value="${paramVO.pSiteId}" />
