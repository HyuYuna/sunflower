...
<ul class="nav nav-tabs">
	...
	<li role="presentation" class="active"><a href="/bos/singl/errorLog/listType.do?menuNo=${paramVO.menuNo}&viewType=${paramVO.viewType}">유형별 통계</a></li>
	<li role="presentation"><a href="/bos/singl/errorLog/listUrlAd.do?menuNo=${paramVO.menuNo}&viewType=${paramVO.viewType}">URL별 통계</a></li>
</ul>

<form name="frm" id="frm" method="get" action="/bos/singl/errorLog/listType.do" onsubmit="return goSearch(this);">
...
<script>
	$(document).ready(function() {
		...
		conectItem.push('${result.errorSj}');
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<c:forEach var="result" items="${result}" varStatus="status">
				<tr>
					<th scope="row">${result.errorSj}</th>
					<td>
						<a href="/bos/singl/errorLog/list.do?menuNo=${paramVO.menuNo}&searchCnd=1&searchWrd=${result.errorSj}&viewType=BODY" target="_blank"  onclick="window.open(this.href, 'errorLog', 'resizable=1, scrollbars=1, width=1200,height=600'); return false;">
