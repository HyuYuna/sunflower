...
<form id="compareForm" name="compareForm" enctype="multipart/form-data" action="/bos/singl/menu/updateContents.do" method="post">
...
$( function() {
  ...
  $('#compareBtn').on( "click", function() {
		$.post(
			"/bos/singl/menu/compareContents.json",
			...
			function(data) {
				...
				$('#orgDownBtn').on('click',function(){
					location.href = '/bos/singl/menu/downloadContents.do?cntntsMnno=' + data.orgVal.cntntsMnno + '&sMenuNo=' + $('#sMenuNo').val();
				});
				$('#orgDownBtn').show();
				$('#modDownBtn').on('click',function(){
					location.href = '/bos/singl/menu/downloadContents.do?cntntsMnno=' + data.modVal.cntntsMnno + '&sMenuNo=' + $('#sMenuNo').val();
				});
				$('#modDownBtn').show();
			},"json"
		);
