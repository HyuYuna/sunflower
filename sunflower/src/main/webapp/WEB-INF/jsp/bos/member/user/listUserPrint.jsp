    ...
    $("#pageSelect").change(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#frm2").attr("action", "/bos/member/user/listUserPrint.do");
                $("#frm2").submit();
            }
        });
    });
...
<form id="frm2" name="frm2" method="post" action="/bos/member/user/listUserPrint.do" onsubmit="return goSearch(this);" class="pure-form">
            ...
            <tbody>
                <c:forEach var="result" items="${resultList}" varStatus="status">
                    <tr>
                        ...
                        <td>${result.phName}<c:if test="${result.caseSeq ne null}"></br>(${result.caseNumber })</c:if></td>
...
<div class="btnSet">
        <a class="pure-button b-down" href="javascript:filePopZip('downloadExcel5','${param.searchCnd1}','${param.searchCnd2}','${param.searchCnd3}','${param.searchCnd4}','${param.searchCnd5}','${param.searchWrd}','${param.orderName}','${param.orderBdate}','${param.sdate1}','${param.edate1}')">엑셀다운</a>
</div>
