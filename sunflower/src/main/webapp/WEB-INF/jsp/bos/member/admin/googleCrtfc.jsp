...
<form name="loginForm" id="loginForm" action ="/bos/member/admin/crtfcLogin.do" method="post">
	...
	<div class="login_form otp-login">
		<div class="tab2_main on">
			<div>
				...
				<input id="googleotp" name="userCode" type="text" value="" title="구글 OTP 인증번호(6자리)" class="poab01 numberOnly" placeholder="구글 OTP 인증번호(6자리)" autocomplete="off" maxlength="6" autofocus="autofocus">
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form name="listForm" id="listForm" action="/bos/member/admin/crtfcLogin.do" method="post">
					<div>
