...
<table cellspacing="0" cellpadding="0">
    <tr style="height:26.25pt;">
        <td colspan="4" class="excel12" style="width:700pt;">출력 이력관리</td>
    </tr>
    <tr>
...
<c:forEach var="result" items="${resultList}" varStatus="status">
    <tr>
        <td class="excel3"   ><fmt:formatDate value="${result.phCdate }" pattern="yyyy-MM-dd HH:mm:ss"/></td>  
        <td class="excel3"   >${result.phName}<c:if test="${result.caseSeq ne null}"></br>(${result.caseNumber })</c:if></td>
        <td class="excel3"   >${result.phUserName}</td>        
