...
<table cellspacing="0" cellpadding="0">
    <tr style="height:26.25pt;">
        <td colspan="6" class="excel12" style="width:700pt;">사용자 입사정보</td>
    </tr>
    <tr>
        <td class="excel2" style="height:16.5pt;border-top:none;">상태</td>
        <td class="excel2" style="height:16.5pt;border-top:none;">센터</td>
        <td class="excel2" style="height:16.5pt;border-top:none;">이름</td>
        <td class="excel2" style="height:16.5pt;border-top:none;">입사일자</td>
        <td class="excel2" style="height:16.5pt;border-top:none;">연도별</td>
        <td class="excel2" style="height:16.5pt;border-top:none;">월별</td>
    </tr>
<c:forEach var="result" items="${resultList}" varStatus="status">
    <tr>
        <td class="excel3"                                >${result.userStateName } </td>                                             
        <td class="excel3"                                >${result.centerCodeName      } </td>                                             
        <td class="excel3"                                >${result.userName        } </td>
        ...
        <td class="excel3" style='mso-number-format: "@";'><fmt:formatDate value="${userBCdate}" pattern="yyyy"/>년</td>     
        <td class="excel3" style='mso-number-format: "@";'><fmt:formatDate value="${userBCdate}" pattern="mm"/>월</td>  
    </tr>
</c:forEach>
</table>
</body>
