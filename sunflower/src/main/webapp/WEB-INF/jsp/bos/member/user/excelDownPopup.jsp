...
<c:set var="action" value="${param.now}.do?loginAuthorCd=${param.loginAuthorCd}&loginCenterCode=${param.loginCenterCode}&searchCnd1=${param.searchCnd1}&searchCnd2=${param.searchCnd2}&searchCnd3=${param.searchCnd3}&searchCnd4=${param.searchCnd4}&searchCnd5=${param.searchCnd5}&searchWrd=${param.searchWrd}&orderName=${param.orderName}&orderBdate=${param.orderBdate}&sdate1=${param.sdate1}&edate1=${param.edate1}&chGroup=${param.chGroup}&chAction=${param.chAction}&viewType=CONTBODY" />
<form id="frm" name="frm" method="post" action="${action}" >
    <input type="hidden" name="now" value="${param.now}" />
