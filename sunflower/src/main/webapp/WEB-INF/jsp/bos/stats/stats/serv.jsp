...
<style>
    ...
    #lblList table { border-collapse: collapse; min-width:960px;width:100%;}
...
<script>
	function filePopZip(){
	    ...
	    var params = "?shDataNm=통계(사례부가정보)&viewType=BODY";
	...
	function fn_export(){
	    ...
	    $(this).attr('download', '통계_사례부가정보.xls').attr('href', uri).attr("target", "_blank");
	}
	function numComma(n) {
		if(n!=null){
	...
	function getResultData(){
		...
		$.ajax({
            type:"post",
            url: "/bos/stats/stats/servStats.json",
            dataType: "json",
			...
			success : function(data){
            	...
            	var servStats = data.servStats;
            	var servStatd = data.servStatd;
				var table = "";
            	...
            	if(codeResult.length >= 0){
            		...
            		if(dsaYN == 'Y'){
            			...
            			table += "<tr><th style='min-width:190px; background-color:#ffffff;' rowspan='" + gubunRowspan + "'>구분</th>";
            			...
            			for(var i=0; i<codeResult.length + 1; i++){
            				table += "<th style='width:60px; padding:5px 0 5px 0;' colspan='" + sexColspan + "'>전체</th>";
                            table += "<th style='width:60px; padding:5px 0 5px 0;' colspan='" + sexColspan + "' class='sellDisable'>장애</th>";
            			}
            			...
            			table += "<th style='min-width:190px; background-color:#ffffff;' rowspan='" + gubunRowspan + "'>구분</th>";
            		...
            		var preGroupCode = "0";
            		var cCode = "";
            		$.each(servStats, function(i, entry) {
            			if(i == 0){
            				if(sexYN == 'Y'){
            					...
            					if(entry["victimSex"] == "M"){
            						for(var t=6; t<data.codeCount2; t++){
            							...
            							if(dsaYN == "Y"){
            								...
            								sumDrray[t] = servStatd[i]["fieldname" + data.codename[t]];
            							}
            						}
            						...
            						for(var t=6; t<data.codeCount2; t++){
            							...
            							if(dsaYN == "Y"){
            								...
            								sumDrray[t] = sumDrray[t] + servStatd[i]["fieldname" + data.codename[t]];
            							}
            						}
...
/*
        ...
        function radioInactive() {
			$("input[name=CASE_SERV]").removeAttr("checked");
		}
			</script>
        ...
        */
			...
			<tr class="trExtend" style="height: 40px;">
				<td style="text-align: center;">사례부가정보<br/><span style="cursor: pointer; text-decoration:underline" onclick="radioInactive()">(초기화)</span></td>
				<td colspan=3 style="padding: 0;">
					<table class="pure-table pure-table-bordered" style="width: 100%; border: 0px; margin: 0;" border="0 nㄱㄱone">
						<colgroup>
						...
						<tr style="height: 20px;">
							...
							<td style="padding: 2px;">
								<span style="display: inline-block; width: 150px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_TYPE">피해구분별
								</span>
								<span style="display: inline-block; width: 230px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_TYPE_GROUP">아동학대범죄 - 가해자구분
								</span> 
								<span style="display: inline-block; width: 200px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_TYPE_ACT">아동학대범죄 - 학대행위구분
								</span>
							</td>
						</tr>
						<tr style="height: 20px;">
							<td style="text-align: center;">[지원경과]</td>
							<td style="padding: 2px;">
								<span style="display: inline-block; width: 200px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP">수사법률지원
								</span> 
								<span style="display: inline-block; width: 200px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_A10">신뢰관계인 동석
								</span> <br> 
								<!--
								<span style="display:inline-block; width:200px;padding:3px;"><input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_B10">의료비지원</span>
								--> 
								<span style="display: inline-block; width: 200px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_B20">의료비지원대상
								</span>
								<!--
								<span style="display:inline-block; width:200px;padding:3px;"><input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_B30">간병비지원</span>
								-->
								<span style="display: inline-block; width: 200px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_B40">간병비지원 사유
								</span>
								<span style="display: inline-block; width: 200px; padding: 3px;">
								<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_B50">응급키트 실시
								</span> <br> 
								<span style="display: inline-block; width: 350px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_B61">인공임신중절 지원-센터가 임신을 확인한 시점
								</span> 
								<span style="display: inline-block; width: 350px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_B62">인공임신중절 지원-인공임신중절 수술시행 병원
								</span>
							</td>
						</tr>
						<tr style="height: 20px;">
							<td style="text-align: center;">[수사법률]</td>
							<td style="padding: 2px;">
								<span style="display: inline-block; width: 120px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_C10">신고
								</span>
								<span style="display: inline-block; width: 120px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_C20">검찰
								</span> 
								<span style="display: inline-block; width: 120px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_C22">재판-1심
								</span> 
								<span style="display: inline-block; width: 120px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_C23">재판-2심
								</span>
								<span style="display: inline-block; width: 120px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_C24">재판-3심
								</span>
							</td>
						</tr>
						<tr style="height: 20px;">
							<td style="text-align: center;">[관리기관]</td>
							<td style="padding: 2px;">
								<span style="display: inline-block; width: 150px; padding: 3px;">
									<input type="radio" name="CASE_SERV" class="CASE_SERV" value="CS_GROUP_D10">주사례관리 이관
								</span>
							</td>
						</tr>
					</table>
			...
			<tr style="height: 40px;">
				...
				<td colspan=3>
					<span style="display: inline-block; width: 80px;">
						<input type="checkbox" name="dsaYN" id='dsaYN' value="Y">장애
					</span>
					<span style="display: inline-block; width: 100px;">
						<input type="checkbox" name="sexYN" id='sexYN' value="Y">성별 구분 
        ...
        */
			...
			<tr style="height: 40px;">
				<td colspan=4><button id="btnAction"
						class='pure-button btnSearch' style="height: 30px; width: 100%;">검색</button></td>
			</tr>
...
<form id="formAgeSetting">
	<input type='hidden' id='ageSetting' name='ageSetting'
		style="width: 400px;" value=''> <input type='hidden'
		id='param_user_id' name='param_user_id' value=''>
</form>
