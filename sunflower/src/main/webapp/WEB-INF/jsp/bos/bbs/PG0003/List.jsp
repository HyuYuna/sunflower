		...
		<c:set var="pQueryStr">
		 ...
		 <c:forEach var="result" items="${resultList}" varStatus="status">
			  <tr>
			    ...
			    <td class="tit">
			    	<a href="/bos/bbs/${paramVO.bbsId}/view.do?nttId=${result.nttId}&${pQueryStr}">${result.nttSj}</a>
			    </td>
				<td>${result.ntcrNm}</td>
				<td>
					<c:if test="${result.answerAt ne 'Y'}"><span class="ico-reply-ing">답변대기</span></c:if>
					<c:if test="${result.answerAt eq 'Y'}"><span class="ico-reply-end">답변완료</span></c:if>
				</td>
