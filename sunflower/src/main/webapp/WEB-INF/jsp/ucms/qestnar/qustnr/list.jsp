...
<p>고객의 소리에 늘 귀기울이는 UNP가 되겠습니다.</p>
<form name="frm" method="get" action="/ucms/qestnar/qustnr/list.do">
	<input type="hidden" name="menuNo" value="${param.menuNo}">
	
<fieldset class="sh">
	<legend>000 목록 검색</legend>
	<div>
		<legend>게시물검색</legend>
		...
		<a href="./list.do?menuNo=${param.menuNo}" class="b-total">전체보기</a>
	</div>
</fieldset>
</form>
...
<div class="bdList">
	<table>
		...
		<c:set var="pQueryStr">
		 ...
		 <c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
			    ...
			    <td class="tit">
			    	<a href="/ucms/qestnar/qustnr/view.do?qustnrSn=${result.qustnrSn}&${pQueryStr}">${result.qustnrSj}</a>
			    </td>
		...
		<c:if test="${fn:length(resultList) eq 0}">
			<tr>
				<td colspan="7" class="nodata"><spring:message code="common.nodata.msg" /></td>
			</tr>
		 </c:if>
		</tbody>
	</table>
